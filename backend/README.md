...
Если есть ошибка 
docker-compose  PermissionError(13, 'Permission denied')
устранить её c помощью `chmod 777 /var/run/docker.sock`
`docker-compose ps` вернет список образов
